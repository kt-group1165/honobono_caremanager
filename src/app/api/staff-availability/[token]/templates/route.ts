...
// GET /api/staff-availability/[token]/templates?category=visit_record
//
// kaigo_record_templates から該当 category + 'common' のテンプレを返す。
// kaigo_record_templates は authenticated 限定 RLS（Phase 2-5-09）のため、
// 未認証経路の TemplatePicker からは service_role API 経由で取得する必要がある。
// kaigo_record_templates は tenant_id を持たないグローバル master だが、
