...
export function SeikyuForm(props: Props) {
  ...
  const h: React.CSSProperties = { border: B, padding: "1px 3px", fontSize: "6.5pt", verticalAlign: "middle", fontFamily: F, background: "#f5f5f5", textAlign: "center" };
    ...
    <div style={{ fontFamily: F, fontSize: "7.5pt", color: "#000", width: "195mm" }}>
      ...
      <table style={{ width: "55%", borderCollapse: "collapse", border: B2, marginBottom: "3mm", marginLeft: "auto" }}>
        <tbody>
          ...
          <tr style={{ height: 20 }}>
            <td style={h}>名称</td>
            <td style={{ ...c, fontWeight: "bold", fontSize: "8.5pt" }}>{officeName}</td>
          </tr>
          <tr>
            <td style={{ ...h, fontSize: "5.5pt" }}>請求<br />事業所</td>
      ...
      <div style={{ fontSize: "7.5pt", marginBottom: "3mm" }}>下記のとおり請求します。　{bm.era}　年　月　日</div>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", border: B2, marginBottom: "3mm" }}>
        <thead>
          ...
          <tr>
            <th style={{ ...h, width: "5%" }}>件数</th>
            <th style={{ ...h, width: "7%" }}>単位数・<br />点数</th>
            <th style={{ ...h, width: "7%" }}>費用合計</th>
            <th style={{ ...h, width: "7%" }}>保険<br />請求額</th>
            <th style={{ ...h, width: "6%" }}>公費<br />請求額</th>
        ...
        <tbody>
          <tr style={{ height: 28 }}>
            <td style={{ ...c, fontSize: "5pt", lineHeight: 1.2 }}>
              居宅・総合事業サービス・<br />介護予防サービス・<br />地域密着型サービス等
            </td>
          ...
          <tr style={{ height: 22 }}>
            <td style={{ ...c, fontSize: "5pt" }}>居宅介護支援・<br />介護予防支援</td>
            <td style={cR}></td><td style={cR}></td><td style={cR}></td><td style={cR}></td><td style={cR}></td><td style={cR}></td>
            <td style={SLASH}></td><td style={SLASH}></td><td style={SLASH}></td><td style={SLASH}></td><td style={SLASH}></td>
          </tr>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", border: B2, marginBottom: "3mm" }}>
        ...
        <tbody>
          {publicRows.map((row) => (
            <tr key={row.code} style={{ height: row.sub ? 28 : 17 }}>
