...
export interface HospitalizationsContentProps {
  userId: string;
  initialUser: UserInfo | null;
  initialRecords: Hospitalization[];
}

export function HospitalizationsContent({
  userId,
  initialUser,
  initialRecords,
}: HospitalizationsContentProps) {
  ...
  const [records, setRecords] = useState<Hospitalization[]>(initialRecords);
                    ...
                    {allAdmitted.map((rec) => {
                      ...
                      return (
                        <tr
                          ...
                          onClick={() => navigateToUser(rec.client_id)}
                        >
