...
export const KEIYAKU_KEN_JUYO_SECTIONS: ContractSection[] = [
  ...
  { key: "juyo_02_overview", label: "別紙2 当事業所の概要 (職員体制・営業日時)", type: "textarea" },
  { key: "juyo_03_flow", label: "別紙3 居宅介護支援の申し込みからサービス提供までの流れと主な内容", type: "textarea" },
  { key: "juyo_04_fee", label: "別紙4 利用料金", type: "textarea" },
  { key: "juyo_05_usage", label: "別紙5 サービスの利用方法", type: "textarea" },
  { key: "juyo_06_features", label: "別紙6 当事業所の居宅介護支援の特徴等", type: "textarea" },
  { key: "juyo_07_complaint", label: "別紙7 サービス内容に関する苦情・相談窓口", type: "textarea" },
 ...
 * 書き換えれば実用に達する。
 *
 * 法令引用は docx 原文を一字一句保持する。
 */
export function getKeiyakuKenJuyoDefaults(): UserContractContent {
  return {
    // 事業者欄は site/office 情報で埋める想定なので空のまま (= autoFillFromOffice で投入)
    company_name: "",
    company_office_name: "",
    company_address: "",
    company_phone: "",
    ...
    article_20:
      "1 災害発生時や感染症流行時などの非常時においては、事業者は従業員の安全を確保した上でサービスを提供するため、事前に合意した日時・内容通りのサービスが提供できない可能性があります。\n2 利用者が避難所に避難された場合には、サービス提供の場所が変わることになりますので、道路状況・人員体制・避難所の環境等を考慮した上で、サービスの提供が可能と事業者が判断した場合にのみサービスを提供するものとします。",
    article_21:
