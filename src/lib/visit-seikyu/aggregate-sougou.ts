...
const SOUGOU_PREFIX_BY_INSURER: Record<string, string> = {
  ...
  // 長生村 (長生郡)
  "124230": "CS_",
  // 大網エリア(大網)+姉崎の袖ケ浦: 各市公式コード表を専用prefixで投入済
  //   (import_sougou_oamishirasato.mjs)。独自A22系(訪問型サービスA/定率)も含む。
  "122390": "OA_", // 大網白里市
  "122374": "SM_", // 山武市
  "124032": "KJ_", // 九十九里町
  "122291": "SD_", // 袖ケ浦市 (姉崎)
...
const SOUGOU_UNITPRICE_BY_INSURER: Record<string, number> = {
  ...
  // 市原市(5級地)・袖ヶ浦市。姉崎ムツミ office(市原)の本物伝送KK260705で両者とも
  // 単価10.70を確認 (袖ヶ浦は他市だが ほのぼのも10.70 = office級地で算定していた)。
  "122192": 10.7, // 市原市 (5級地)
  "122291": 10.7, // 袖ヶ浦市 (姉崎で10.70。ほのぼの実伝送に一致)
