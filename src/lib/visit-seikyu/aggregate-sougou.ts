...
const SOUGOU_PREFIX_BY_INSURER: Record<string, string> = {
  ...
  // 長生村 (長生郡)
  "124230": "CS_",
  // ↓ 大網白里営業所エリア。いずれも「みなし現行相当」コード(A21xxx)+処遇改善(A26184)
  //   のみ使用し、独自(A22xxx)コードは使わない。みなし現行相当の単位数は全国共通
  //   (DB検証済: CB_/MB_ で A21111=1176/A21211=2349/A26184=266 完全一致) なので、
  //   既存の茂原市コード表(MB_)を流用する。単価は各市町村の級地で別途上書き(下記)。
  "122390": "MB_", // 大網白里市
  "122374": "MB_", // 山武市
  "124032": "MB_", // 九十九里町
};
