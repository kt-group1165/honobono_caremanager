...
export function buildSougouDensou(
  ...
  for (const r of rows) {
    ...
    dataParts.push([
      ...
      // 18 認定有効期間 終了。
      //   ⚠ **事業対象者 (要介護状態区分 06) は空**。認定を受けていないので終了日が無い。
      //   ほのぼの実伝送 2026-06 の 71R1 種別01 268 件で例外ゼロ:
      //     06 → 終了日 空 5/5 / 12・13 → 終了日 有 263/263。
      //   当方は 06 にも終了日を入れており (21171231 のような値まで出ていた)、
      //   花見川・五井・やわた で不一致になっていた。
      careLevelCode === "06" ? "" : dateNum(r.certEnd), // 18 認定有効期間 終了
