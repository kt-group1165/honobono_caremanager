...
import { AREA_OFFICES, NOT_OFFICE, ALL_KYOTAKU } from "./_area_offices.mjs";
...
// ── 拠点フォルダ → offices.name ────────────────────────────────────────────
//   表そのものは migrations/_area_offices.mjs に移した。
//   propose_meisai_client_mapping.mjs でも同じ表が要るため
//   (向こうは部分一致で引いていて K姉・姉ム・袖ケ浦・茂原 が 0 件だった)。
//   **増やすときは _area_offices.mjs だけを直す。**
