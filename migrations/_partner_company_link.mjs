...
// ロジックは migrations/partner_companies_backfill.mjs (モノレポ直下) /
// src/app/(authenticated)/master/partner-companies.ts の upsertPartnerCompany と同一
// (13桁法人番号 → 法人名 の順で名寄せ。opendata の corp_number は Excel 経由で
// 大半が壊れているため法人名フォールバックが主経路になる)。
//
